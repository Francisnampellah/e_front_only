            ...
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full outline-none bg-white focus:outline-none">
                ...
                <div className="relative p-6 md:w-[60%] flex-auto justify-center items-center">
                  ...
                  <label
                    for="User name"
                    class="block overflow-hidden my-4 rounded-md border border-gray-400 px-3 py-2 shadow-sm focus-within:border-blue-600 focus-within:ring-1 focus-within:ring-blue-600"
                  >
